...
button_add=Button(root, text="+", padx=100, pady=20, command=button_add)
button_equal=Button(root, text="=", padx=100, pady=20, command=button_equal)
button_subtract=Button(root, text="-", padx=100, pady=20, command=button_subtract)
button_multiply=Button(root, text="*", padx=100, pady=20, command=button_multiply)
button_divide=Button(root, text="/", padx=100, pady=20, command=button_divide)
#button_1=Button(root, text="1", padx=40, pady=20, command=button_subtract)
